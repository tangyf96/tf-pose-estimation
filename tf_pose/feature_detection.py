...
def get_five_features(image,ymin,ymax,xmin,xmax):
    ...
    for j in get_moment(ymin,xmin,ymax,xmax,image).tolist():
        feature.append(j)
    feature.append(approx_shape(ymin,xmin,ymax,xmax,image))
    r=get_amp(ymin,xmin,ymax,xmax,image)[0]
    g=get_amp(ymin,xmin,ymax,xmax,image)[1]
    b=get_amp(ymin,xmin,ymax,xmax,image)[2]
    feature.append(r)
    feature.append(g)
    feature.append(b)
    return feature
